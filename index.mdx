...
<Columns cols={2}>
  <Card icon="user-large" title="Administrator">
  ...
  <Card icon="user-pilot" title="Auditor">
...
<Columns cols={2}>
  <Card icon="pen-fancy" title="Penetapan">
  ...
  <Card icon="code" title="Pelaksanaan">
  ...
  <Card icon="image" title="Evaluasi (AMI)">
  ...
  <Card icon="recycle" title="Pengendalian dan Peningkatan">
